...
@endif
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="inputEmail2" placeholder="123">
    </div>
    <div class="form-group col-md-6">
    <label for="inputEmail3">Fecha</label>
    <input type="date" class="form-control" id="inputEmail3"   placeholder="2018-07-22" min="2020-01-01" max="2022-06-20">
  </div>
...
<div class="container" style="padding-top: 0px;padding-bottom: 20px;">
    ...
    <div class="form-group col-md-4">
      ...
      <select id="inputEmail11" class="form-control">
...
<div class="container" style="padding-top: 0px;padding-bottom: 20px;">
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="inputEmail7" placeholder="123">
    </div>
...
<div class="container" style="padding-top: 0px;padding-bottom: 20px;">
    ...
    <div class="form-group col-md-8">
      ...
      <select id="inputEmail7" class="form-control">
        <option selected>1</option>
        <option>2</option>
      </select>
    </div>
